    ...
    service = Service.getInstance(
      new EnvironmentConfig({
        DEMO_MODE: process.env.DEMO_MODE
          ...
          : undefined,
        // both were previously never read from process.env here, silently
        // breaking matchingmanager.ts's payment-confirmation call (API_URL)
        // and bankaccountmanager.ts's SCA redirect URL (LANDLORD_APP_URL)
